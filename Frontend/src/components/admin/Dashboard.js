							...
							<div className="row pr-4">
								<div className="col-xl-3 col-sm-6 mb-3">
									<div className="card text-white bg-success o-hidden h-100">
										...
										<Link className="card-footer text-white clearfix small z-1" to="/getallbook">
								...
								<div className="col-xl-3 col-sm-6 mb-3">
									<div className="card text-white bg-danger o-hidden h-100">
										...
										<Link className="card-footer text-white clearfix small z-1" to="/author">
											<span className="float-left">View Details</span>
											<span className="float-right">
												<i className="fa fa-angle-right"></i>
											</span>
								...
								<div className="col-xl-3 col-sm-6 mb-3">
									<div className="card text-white bg-info o-hidden h-100">
										<div className="card-body">
											<div className="text-center card-font-size">Users<br /> <b>{userInfo && userInfo.length}</b></div>
										</div>
